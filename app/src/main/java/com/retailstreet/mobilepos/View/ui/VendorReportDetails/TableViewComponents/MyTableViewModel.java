...
public class MyTableViewModel {
    ...
    private List<ColumnHeaderModel> createColumnHeaderModelList() {
        ...
        list.add(new ColumnHeaderModel("GRN QTY"));
        list.add(new ColumnHeaderModel("FREE QTY"));
    ...
    private List<List<CellModel>> createCellModelList(List<User> userList) {
        ...
        for (int i = 0; i < userList.size(); i++) {
            ...
            list.add(new CellModel("4-" + i, user.PUR_PRICE));
            list.add(new CellModel("5-" + i, user.GRN_QTY));
            list.add(new CellModel("6-" + i, user.FREE_QTY));
