 ...
 */
public class VendorReturnListAdapter extends CustomRecyclerViewAdapterVR<VendorReturnListAdapter.ViewHolder> implements RefreshRecyclerView {
    ...
    public VendorReturnListAdapter(Context context, Cursor cursor , View parentLayout , Activity activity){
    ...
    public void swapCursors(Cursor cursor) {
        swapCursor(  new ControllerVendorReturn().refreshVendorReturnCursor());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        int cursorCount =0;
        public View root;
        VendorReturnListItem myListItem;
        ...
        public ViewHolder(View view, RefreshRecyclerView refreshView) {
            ...
            remove_order.setOnClickListener(v -> {
                ...
                if (count>1) {
                    ...
                    Cursor cursor1 = new ControllerVendorReturn().refreshVendorReturnCursor();                        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            ...
            clear_order.setOnClickListener(v -> {
                ...
                String primary= myListItem.getPrimary();
                deletefromList(primary);
                Cursor cursor1 = new ControllerVendorReturn().refreshVendorReturnCursor();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.vendor_return_list_view_item, parent, false);
    ...
    public static void deletefromList(String key){
        try {
            ...
            db.delete("tmp_vendor_return", "GRNDETAILID = '" + key +"'", null);
            db.close();
            Log.d("DeletedItem", "deletefromList: "+key);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    public static void upDateReturnData(String id,String count){
        try {
            SQLiteDatabase db = context.openOrCreateDatabase("MasterDB", Context.MODE_PRIVATE, null);
            String strSQL = "UPDATE tmp_vendor_return SET GRN_QTY = "+count+" WHERE GRNDETAILID = '"+ id+"'";
            db.execSQL(strSQL);
            db.close();
    ...
    public static  String getAmountTotal(){
        try {
            SQLiteDatabase db = context.openOrCreateDatabase("MasterDB", Context.MODE_PRIVATE, null);
            String query = "select GRN_QTY,PUR_PRICE from tmp_vendor_return";
    ...
    public static int getCursorCount(Cursor cursor){
        SQLiteDatabase db = context.openOrCreateDatabase("MasterDB", Context.MODE_PRIVATE, null);
        return (int)DatabaseUtils.queryNumEntries(db, "tmp_vendor_return");
    }

    public static String getFormatDate(String rawDate){
