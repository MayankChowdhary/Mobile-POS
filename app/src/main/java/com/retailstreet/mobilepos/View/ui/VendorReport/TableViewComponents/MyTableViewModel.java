...
public class MyTableViewModel {
    ...
    private List<ColumnHeaderModel> createColumnHeaderModelList() {
        ...
        list.add(new ColumnHeaderModel("CASHIER"));
        list.add(new ColumnHeaderModel("VENDOR NAME"));
        list.add(new ColumnHeaderModel("INVOICE NO."));
        list.add(new ColumnHeaderModel("INVOICE DATE"));
        list.add(new ColumnHeaderModel("GRAND AMOUNT"));
        list.add(new ColumnHeaderModel("GRN DATE"));
    ...
    private List<List<CellModel>> createCellModelList(List<User> userList) {
        ...
        for (int i = 0; i < userList.size(); i++) {
            ...
            list.add(new CellModel(user.INVOICE_NO , user.CASHIER,user.MASTER_ID));          // "Id"
            list.add(new CellModel(user.INVOICE_NO , user.VENDOR_NM,user.MASTER_ID));        // "Name"
            list.add(new CellModel(user.INVOICE_NO , user.INVOICE_NO,user.MASTER_ID));    // "Nickname"
            list.add(new CellModel(user.INVOICE_NO , user.INVOICE_DATE,user.MASTER_ID));       // "Email"
            list.add(new CellModel(user.INVOICE_NO , user.GRAND_AMOUNT,user.MASTER_ID));   // "BirthDay"
            list.add(new CellModel(user.INVOICE_NO , user.GRN_DATE,user.MASTER_ID));      // "Gender"
