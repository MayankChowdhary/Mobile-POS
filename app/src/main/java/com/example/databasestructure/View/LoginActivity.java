...
import com.example.databasestructure.Controller.ControllerUserMaster;
import com.example.databasestructure.Controller.DBReadyCallback;
import com.example.databasestructure.Database.SQLiteDbBuilder;
import com.example.databasestructure.Database.SQLiteDbInspector;
import com.example.databasestructure.Database.TableDataInjector;
        ...
        login.setOnClickListener(v -> {
            ...
            if (user_id.isEmpty() || pass.isEmpty()) {
                ...
                if (SQLiteDbBuilder.dbOk && !SQLiteDbInspector.isTableNotEmpty("group_user_master", getApplicationContext(), "MasterDB")) {
                    ...
                    new TableDataInjector(getApplicationContext(), user_id, LoginActivity.this);
